...
Чуть позже имеет смысл **проанализировать ARPPU** и на основе этих данных усилить развитие источника или источников
<br>
...
>При следующих расчётах была **обнаружена аномалия** в данных. Далеко **не все пользователи**, совершившие покупку **присутствуют в таблице `users`**. Из-за этого некоторые столбцы имеют пропущенные значения, заменённые на `UNKNOWN`
...
В файле `analysis.ipynb` корневой папки располагается *Jupyter Notebook*. Ход работы описан в разделе *Анализ первичных гипотез* (заголовок H1)
